...
from preprocessing.khaiii import khaiii_encoder
from preprocessing.konlpy import konlpy_encoder
from preprocessing.sentencepiece import sentencepiece_encoder
...
def preprocessing(args):
    ...
    if args.test_data_preprocessing:
